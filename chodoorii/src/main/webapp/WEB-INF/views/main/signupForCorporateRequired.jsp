    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="progressWhere">
                <span data-target="sort" ><img src="../img/2025986.svg" style="visibility:hidden ;" width="30px" height="10px" alt="">회원유형선택</span>
                <span data-target="required"><img src="../img/2025986.svg"  width="30px" height="10px" alt="">필수정보입력</span>
                ...
                <form method="POST" enctype="multipart/form-data" action="http://localhost:8088/signup?sort=1">
                     <div class="input-group" style="display: flex; flex-direction: row;">
                        <img src="../img/defaultpic.png" class="img-thumbnail userpic" alt="..." width="150px" height="100px">
                    ...
                    <div class="input-group mb-3">
                        <input data-target="required"  type="text" class="form-control" placeholder="회사명을 입력해주세요" name="name" aria-label="Example text with button addon" aria-describedby="button-addon1">
                    </div>
