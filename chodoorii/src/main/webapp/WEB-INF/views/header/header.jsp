			...
			<c:otherwise>
				<div>
					<a class="dropdown-item" href="chat" data-bs-toggle="modal"
						data-bs-target="#moaModal"><img id="bell-img" src="/publish/main/img/벨2.jpg"
						style="height: 40px" onclick="this.src='/publish/main/img/벨2.jpg'"> </a>
				</div>
				<div class="signupAndLogin">
					<div class="infoBox">
						<div class="mainTop">
							...
							<div class="mainSide">
								<button type="button" id="userid" class="btn btn-primary"
									style="margin-bottom: 10px;">${userInfo.id}</button>
						...
						<div class="row">
							<div class="col-md-12">
								<table id="message-history" class="table table-striped">
									...
									<tbody id="messages">
										<c:forEach var="alram" items="${Aldto}">
											<tr>
												<td>${alram.message}</td>
											</tr>
										</c:forEach>
	...
	<script>
               window.addEventListener('load',function(){
             		...
             		loginBtn.addEventListener('click',(e)=>{
             			...
             			var btn = document.querySelector('#bell-img');
             			console.log(btn);
