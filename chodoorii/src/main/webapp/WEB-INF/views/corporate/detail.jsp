				...
				<c:otherwise>
					<div class="signupAndLogin">
						<button type="button" class="btn btn-primary"
							...
							data-bs-whatever="@mdo" id="share">공유하기</button>
						</button>
					</div>
		</div>
	</div>
			...
			<div class="modal-content" style="height: 500px">
				...
				<form style="width: 500px" method="post" action="/resume/share/mail"
					...
					<div class="  modal-body">
						<div class="mb-3">
							<input type="hidden" id="toUser" name="toUser" value="${detail.userid.id}">
							<!-- 보낼 상대 id값  -->
							<input type="hidden" id="fromUser" name="fromUser" value="${userInfo.id}">
							<!-- 내 id값  -->
							<label for="recipient-name" class="col-form-label">받으시는 분
								메일</label> <input type="text" class="form-control" id="recipient-name"
								name="to" value="${detail.userid.email}" readonly>
						</div>
						<div class="mb-3">
...
function sendMessage() {
    ...
    stompClient.send("/ws/share", {}, JSON.stringify({'fromwhom':fromUser,'towhom':toUser}));
