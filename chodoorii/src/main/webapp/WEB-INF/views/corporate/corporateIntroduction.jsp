 ...
 <div class="wrapper">
        <div class="introduce" style="text-align: center;">
            <form action="/corporate/register" method="POST">
                <h3>${userName}</h3><br>
                <textarea  id="" cols="80" rows="10" style="resize: none;" maxlength="500" name="summary" placeholder="최대 500자 까지 입력가능."></textarea>
                <br>
                <label for="hireNum">채용 인원 </label>
                    <input type="text" name="staffNumber" placeholder="최대 300" maxlength="300" style="text-align: right;">명
                ...
                <label><input type="checkbox" name="wlfare" value="연차"><img src="/publish/corporate/img/연차.jpg" alt=""><br>자유로운 연차 사용</label>
                <label><input type="checkbox" name="wlfare" value="식대제공"><img src="/publish/corporate/img/식대제공.jpg"><br>식대 제공</label>
                <label><input type="checkbox" name="wlfare" value="유연근무제"><img src="/publish/corporate/img/유연근무제.jpg" alt=""><br>유연근무제 운영</label>
                <label><input type="checkbox" name="wlfare" value="도서지원"><img src="/publish/corporate/img/도서지원.png" alt=""><br>자기계발 도서 지원</label>
              </div>
